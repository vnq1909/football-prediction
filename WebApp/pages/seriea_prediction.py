...
st.set_page_config(page_title="Dự đoán Serie A", layout="wide", page_icon="⚽")
st.markdown("""
    <style>
    body, .stApp {
...
st.title("Bảng dự đoán kết quả Serie A")

pred_path = os.path.join('Datasets', 'Predictions', 'predictions_serieA_italy.csv')
if os.path.exists(pred_path):
    ...
    if not pred_df.empty:
        ...
        st.warning("File dự đoán Serie A rỗng!")
else:
    st.warning("Không tìm thấy file dự đoán Serie A!") 